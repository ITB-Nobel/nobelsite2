...
export default function SliderContent() {
    return <div className={"relative lg:absolute  px-4 px-12 lg:px-24 py-12 lg:py-6 bg-black lg:bg-transparent lg:top-24 w-full text-left"}>

        {/*<div className={"lg:mt-[130px] lg:ml-12 lg:w-1/4 text-white"}>*/}
        {/*    <h1*/}
